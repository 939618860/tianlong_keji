		$(function () {
			$("#box>.boxing").hover(function () {
				$(this).find(".boxing-child").stop(true, true).animate({"marginBottom": 0,"lineHeight": "200px","fontSize": "25px"}, 300);
			}, function () {
				$(this).find(".boxing-child").stop(true, true).animate({"marginBottom": "-140px","lineHeight": "25px","fontSize": "18px"}, 300);
			});
		});
var banner = {
	//图片容器
	...
	createLiOfImg: function () {
		...
		for (var i = 0; i < imgLength; i++) {
			var $li = $('<li><img src="./images/index/' + this.imgContainer[i] + '"></li>');
			$banner.append($li);
		}
